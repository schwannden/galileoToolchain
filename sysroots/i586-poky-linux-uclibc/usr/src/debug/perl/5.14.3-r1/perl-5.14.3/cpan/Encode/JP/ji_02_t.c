/*
 ...
 /home/schwannden/ndn/Galileo-Runtime/meta-clanton_v1.0.1/yocto_build/tmp/sysroots/x86_64-linux/usr/bin/perl-native/perl5.14.3.real ../bin/enc2xs -Q -o ji_02_t.c -f ji_02_t.fnm
 enc2xs VERSION 2.07
*/
#include "encode.h"
