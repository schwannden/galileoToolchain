...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/usr/i586-poky-linux-uclibc/lib32\"); SEARCH_DIR(\"=/usr/local/lib32\"); SEARCH_DIR(\"=/lib32\"); SEARCH_DIR(\"=/usr/lib32\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
