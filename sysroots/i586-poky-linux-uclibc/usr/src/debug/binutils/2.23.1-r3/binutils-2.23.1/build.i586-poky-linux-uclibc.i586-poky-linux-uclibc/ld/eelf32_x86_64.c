...
static bfd_boolean
gldelf32_x86_64_check_ld_so_conf (const char *name, int force)
{
  ...
  for (l = needed; l != NULL; l = l->next)
      ...
      for (force = 0; force < 2; force++)
	{
	  ...
	  for (; !found && rp != NULL; rp = rp->next)
	    {
	      char *tmpname = gldelf32_x86_64_add_sysroot (rp->name);
	      found = (rp->by == l->by
	  ...
	  if (gldelf32_x86_64_check_ld_so_conf (l->name, force))
	    break;
...
OUTPUT_ARCH(i386:x64-32)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/usr/i586-poky-linux-uclibc/libx32\"); SEARCH_DIR(\"=/usr/local/libx32\"); SEARCH_DIR(\"=/libx32\"); SEARCH_DIR(\"=/usr/libx32\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
